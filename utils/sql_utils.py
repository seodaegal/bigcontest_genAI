...
def convert_question_to_sql(type):
    ...
    - 이용건수, 이용금액, 건당평균이용금액은 낮은지 높은지나 BETWEEN 확인하지말고 '상위 10' 혹은 '25~50' 같이 정확한 워딩을 LIKE를 써서 검색해
