from utils.config import model, df, text2_df 
...
def main():
    ...
    if int(which_csv) == 1:
        ...
        if sql_results.empty:
            ...
            embeddings = np.load('/root/real_restaurant_embeddings_array_file.npy')
        ...
        top_300 = text2faiss(question, '/root/shcard_bigcontest2024_llm/modules/text2_restaurant_faiss.index', '/root/shcard_bigcontest2024_llm/modules/text2_restaurant_embeddings.npy', text2_df)
